...
(function() {
  ...
  this.set_nav_text = function() {
    alert("asd");
    $(this).find('.sb-nav-link').on('click', function() {
      alert("sb-nav-linksb-nav-link");
    });
  };
  ...
  handler_ready = function() {
    window.escape();
    return window.set_nav_text();
  };

  $(document).on('ready page:load', handler_ready);
